$(function() {
    ...
    const patternAdresse = /^[a-zA-Zéèêëîïôöàäâûü0-9 \'._-]*$/;
    ...
    const verificationAdresse = () => {
        ...
        else if (!patternAdresse.test(adresse)) {
            $("#adresse").css("border", "1px solid red");
    ...
    $(".modification-cuisiniere").submit(function() {

        if( (verificationNom()) && (verificationPrenom()) && (verificationAdresse()) && (verificationCp()) && (verificationVille()) && (verificationTel()) && (verificationEmail()) && (verificationMdp()) && (confirmation())) {
